...
<form action="<%=request.getContextPath()%>/update-booking" method="POST">
    ...
    <table>
        <tr>
            ...
            <th>:</th>
            <td><input type="text" value="<%= tutor.getName() %>" readonly></td>
        </tr>
        <tr>
            <th><label for="subject">Name</label></th>
            <th>:</th>
            <td><input type="text" value="<%= tutor.getSubject() %>" readonly></td>
        </tr>

        <tr>
            <th><label for="booking-date">Book Date</label></th>
            <th>:</th>
            <td><input type="date" name="booking-date" value="<%= booking.getDate() %>" required></td>
        </tr>

        <tr>
            <th><label for="booking-time">Book Date</label></th>
            <th>:</th>
            <td><input type="time" name="booking-time" value="<%= booking.getTime() %>" required></td>
        </tr>
