...
@WebServlet(name = "TutorsAdminViewServlet", value = "/tutors-admin-view")
public class TutorsAdminViewServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/tutors-admin-view.jsp").forward(request, response);
    }
}
